...
public class MouseListener extends MouseAdapter {
	...
	public MouseListener(Game game, Handler handler, HUD hud, SpawnEasy spawnerE, Spawn1to10 spawner,
			Spawn10to20 spawner2, UpgradeScreen upgradeScreen, Player player, Upgrades upgrades, Pause pause) {
		this.game = game;
	...
	public void mousePressed(MouseEvent e) {
		...
		} else if (game.gameState == STATE.GameWon || game.gameState == STATE.GameWonEasy) { // is the game is won, or
																								// its the easy mode
